...
public class Options {
    ...
    public static final Option<Boolean> INVOKEDYNAMIC_INVOCATION_YIELD = bool(INVOKEDYNAMIC, "invokedynamic.invocation.yield", false, "Bypass polymorphic yield logic by using invokedynamic.");
