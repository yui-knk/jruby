 ...
 */
public class RubyArrayThreeObject extends RubyArraySpecialized {
    private IRubyObject elt0;
    private IRubyObject elt1;
    private IRubyObject elt2;

    public RubyArrayThreeObject(Ruby runtime, IRubyObject elt0, IRubyObject elt1, IRubyObject elt2) {
    ...
    public RubyArrayThreeObject(RubyClass otherClass, IRubyObject elt0, IRubyObject elt1, IRubyObject elt2) {
        // packed arrays are omitted from ObjectSpace
    ...
    RubyArrayThreeObject(RubyArrayThreeObject other) {
        this(other.getMetaClass(), other.elt0, other.elt1, other.elt2);
    }

    RubyArrayThreeObject(RubyClass metaClass, RubyArrayThreeObject other) {
        this(metaClass, other.elt0, other.elt1, other.elt2);
    }

    @Override
    public final IRubyObject eltInternal(int index) {
        if (!packed()) return super.eltInternal(index);
        else if (index == 0) return elt0;
        else if (index == 1) return elt1;
        else if (index == 2) return elt2;
    ...
    public final IRubyObject eltInternalSet(int index, IRubyObject value) {
        ...
        if (index == 0) return this.elt0 = value;
        if (index == 1) return this.elt1 = value;
        if (index == 2) return this.elt2 = value;
        throw new ArrayIndexOutOfBoundsException(index);
    }
    ...
    public RubyArray aryDup() {
        ...
        return new RubyArrayThreeObject(getRuntime().getArray(), this);
    }
    ...
    public IRubyObject dup() {
        ...
        return new RubyArrayThreeObject(this);
    }
...
//
//        if (cnt % 2 == 1) return new RubyArrayThreeObject(context.runtime, cdr, car);
//        return new RubyArrayThreeObject(context.runtime, car, cdr);
//    }
//
//    @Override
...
//        if (y.size() == 0) return new RubyArrayThreeObject(this);
...
//
//        return new RubyArrayThreeObject(getMetaClass(), cdr, car);
//    }
//
//    @Override
...
//            return new RubyArrayThreeObject(metaClass, this);
//        }
//
//        // beg == 1, len >= 1
